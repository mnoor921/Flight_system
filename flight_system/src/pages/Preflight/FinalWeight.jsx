            ...
            <Container className="my-3">
                <Row>
                    ...
                    <Col md="8" className="p-4" style={{ border: '1px solid silver', minHeight: '95vh', }}>
                        ...
                        <h4 className="text-center text-white text-uppercase">final weight manifest</h4>
                        ...
                        <div className="m-5 text-center">
                            ...
                            <p className="text-uppercase">Press SEND to Request  <br/> Final weight manifest </p>
