        ...
        <Row>
          ...
          >
            ...
            <form action="">
                ...
                <div className="d-flex mt-2">
                    <label htmlFor="" className="w-25 text-right">atis:</label>
                    <input type="text" placeholder="[]" className="mx-2" style={{width:'30px'}} />
                </div>
...
export default DepartureClearance;
