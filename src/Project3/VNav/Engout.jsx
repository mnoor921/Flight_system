                    ...
                    <div className="col-md-10 col-9 px-0">
                      <div className="bg-dark-main">
                        <div className="numbering d-flex-1">
                          <label htmlFor=""></label>
                          <label htmlFor="">act eo d/d</label>
                        ...
                        <div className="d-flex-1">
                          ...
                          <div className="text-right mr-0 ">
                            <br />
                            <br />
                            <p className="mt-1">to fl246 </p>
                            <label htmlFor=""> 1920z/ 1512nm </label>

                            <p className=""> eta/fuel w/mod </p>
                            <label htmlFor="">2030z/ 34.5</label>
                            <div
                              className="d-flex-1"
                            ...
                            >
                              <div className="mr-4">
                                <p>opt</p>
                                <label htmlFor="">fl370</label>
                              </div>
                              <div className="mr-4">
                                <p>max</p>
                                <label htmlFor="">fl246</label>
                              </div>
                        ...
                        >
                          ...
                          <div className="text-right mr-0">
                            <p className=""> </p>
                            <label htmlFor="">
                              all eng<i className="fa fa-angle-right ml-1"></i>
                            </label>
                          </div>
                        </div>
