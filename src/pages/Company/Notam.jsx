            ...
            <Container className="my-3">
                <Row>
                    ...
                    <Col md="8" className="p-4" style={{ border: '1px solid silver', minHeight: '95vh', }}>
                        ...
                        <h4 className="text-center text-white text-uppercase">Notam <br /> Request</h4>
                        <hr />
                        ...
                        <Form className="m-3">
                            ...
                            <div className="d-flex" style={{ justifyContent: 'space-between' }}>
                                ...
                                <Form.Check
                                    ...
                                    id={`default`}
                                    label={`Airport Notams`}
                                />
                                <p>
                                    <label htmlFor="">Airport :</label>
                                    <span style={{ margin: '0px 10px', width: '20px' }}><input type="text" placeholder="XXXX" /></span>
                                </p>
