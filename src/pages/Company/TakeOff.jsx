            ...
            <Container className="my-3">
                <Row>
                    ...
                    <Col md="8" className="p-4" style={{ border: '1px solid silver', minHeight: '95vh', }}>
                        ...
                        <h4 className="text-center text-white text-uppercase">Takeoff data Request</h4>
                        ...
                        <Row>
                            ...
                            <Col>
                                ...
                                <div className="anti-ice">
                                    ...
                                    <div className="checkbox-style ml-3">
                                        <Form>
                                            {['checkbox'].map((type) => (
                                        ...
                                        <br />
                                        <label htmlFor="">Runway Condition:</label>
                                        <Form>
                                            {['checkbox'].map((type) => (
                                                <div key={`default-${type}`} className="mb-3">
                                                    <Form.Check
                                        ...
                                        <Link to="/takeoff2" className="btn btn-1 float-right">Clutter type/Depth <br /> Page 2</Link>
