            ...
            <Container className="my-3">
                <Row>
                    ...
                    <Col md="8" className="p-4" style={{ border: '1px solid silver', minHeight: '95vh', }}>
                        ...
                        <hr />
                        <h4 className="text-center text-white text-uppercase">Prvious Flight</h4>
                        ...
                        <Form>
                            ...
                            <Link to="/ooo1time" className="btn btn-1 float-right">Go Back</Link>
