        ...
        <Row>
          ...
          >
            ...
            <form action="">
                ...
                <div className="d-flex mt-2">
                    <input type="radio"/>
                    <label htmlFor="" className="ml-3">departure</label>
                </div>
                <div className="d-flex mt-2">
                    <input type="radio"/>
                    <label htmlFor="" className="ml-3">enroute</label>
                </div>
                <div className="d-flex mt-2">
                    <input type="radio"/>
                    <label htmlFor="" className="ml-3">arrival</label>
                </div>
                <div className="d-flex mt-2">
                    <input type="radio"/>
                    <label htmlFor="" className="ml-3">arrival with automatic update</label>
                </div>
                <div className="d-flex mt-2">
                    <input type="radio"/>
