            ...
            <div className="main-section p-2">
              ...
              <div className="row">
                ...
                <div className="col-md-10 col-9 pos-1">
                  <div className="d-flex-1">
                    <div className="model-indent">
                      ...
                      <p>dme l </p>
                      <label htmlFor="">
                        iptnm <span className="ml-2">108.30</span>
                      </label>{" "}
                      <br />
                      <label htmlFor="">
                        ihew <span className="ml-3">110.50</span>
                      </label>{" "}
                      <br />
                      <label htmlFor="">
                        icxo <span className="ml-4">108.70</span>
                      </label>{" "}
                      <br />
                      <label htmlFor="">
                        iah <span className="ml-4">116.60</span>
                      </label>{" "}
                      <br />
                      <br />
                      <br />
                ...
                <div className="col-md-1 col-1 side-btn">
                  ...
                  <Link className="btn btn-1 side-button"></Link>
                  <Link className="btn btn-1 side-button"></Link>
                  <Link to="/Navpos" className="btn btn-1 side-button"></Link>
                </div>
              </div>
            </div>
            <div className="row mt-3 footer_all_btn p-2">
              <div className="col-md-4 col-4 ">
                <div className="row">
                  ...
                  <div className="col-md-6 col-6 mt-1  ">
                    <Link to="/Navstatus2" className="btn btn-1 w-100">
                      Next page
                    </Link>
                  </div>
