      ...
      <Container className="my-3">
                ...
                <div className="col-md-10 col-9">
                  <div className="d-flex-1 ">
                    <div className=" ">
                      ...
                      <p className="">then</p>
                      <label htmlFor=""> [][][][] </label>
                      <p className="">----- Route Discontinuty</p>
                      <label htmlFor="">sxc</label>
                    </div>

                    <div className="text-right">
                      <p className="text-left">63nm</p>
                      <label htmlFor="">.832/fl300</label>
        ...
        <div className="col-md-4 col-4 ">
          <div className="row">
            ...
            <div className="col-md-6 col-6  mt-1 ">
              <Link to="/ActLeg1777" className="btn btn-1 w-100">Prev page</Link>
            </div>
            <div className="col-md-6 col-6 mt-1  ">
              <Link to="/ActLeg3777" className="btn btn-1 w-100">Next page</Link>
            </div>
